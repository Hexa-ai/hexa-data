              ...
              <div class="flex flex-row">
                <div class="basis-2/4">
                  <div class="flex-col">
                    <div class="pt-2">
                      <InputField
                        :title="$t('projectInfos.title') + (' (' + store.currentProject.l1 + ')')"
                        v-model="refData.L1"
                        :isRequired="false"
                        :isDisabled="false"
                        :type="FieldType.TEXT"
                    ...
                    <div class="pt-2">
                      <InputField
                        :title="$t('projectInfos.title') + (' (' + store.currentProject.l2 + ')')"
                        v-model="refData.L2"
                        :isRequired="false"
                        :isDisabled="false"
                        :type="FieldType.TEXT"
                    ...
                    <div class="pt-2">
                      <InputField
                        :title="$t('projectInfos.title') + (' (' + store.currentProject.l3 + ')')"
                        v-model="refData.L3"
                        :isRequired="false"
                        :isDisabled="false"
                        :type="FieldType.TEXT"
                      ...
                      <div class="pt-2">
                        <span class="relative z-0 inline-flex shadow-sm rounded-md mt-3">
                          <button
                            ...
                            type="button"
                            :class="[
                              refData.headerJustify == 'left' ? 'bg-gray-300' : '',
                              'relative inline-flex items-center px-4 py-2 rounded-l-md border border-gray-300 bg-white text-sm font-medium text-gray-700  focus:z-10 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500',
                            ]"
                          >
                            <MenuAlt2Icon
                          ...
                          <button
                            ...
                            type="button"
                            :class="[
                              refData.headerJustify == 'center' ? 'bg-gray-300' : '',
                              '-ml-px relative inline-flex items-center px-4 py-2 border border-gray-300 bg-white text-sm font-medium text-gray-700  focus:z-10 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500',
                            ]"
                          >
                            <MenuIcon class="flex-shrink-0 h-5 w-5 text-gray-400"></MenuIcon>
                          </button>
                          <button
                            @click="justify('right')"
                            type="button"
                            :class="[
                              refData.headerJustify == 'right' ? 'bg-gray-300' : '',
                              '-ml-px relative inline-flex items-center px-4 py-2 rounded-r-md border border-gray-300 bg-white text-sm font-medium text-gray-700 focus:z-10 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500',
                            ]"
                          >
                            <MenuAlt3Icon
                              class="flex-shrink-0 h-5 w-5 text-gray-400"
                    ...
                    <div class="pt-2 flex">
                      <InputField
                        class="basis-1/2"
                        :title="$t('dashboards.autoRefresh')"
                        v-model="refData.autoRefresh"
                        :isRequired="false"
                        :isDisabled="false"
                        :choices="[
                          'none',
                        ...
                        :values="[-1, 1, 5, 10, 15, 30, 60, 300, 600, 1800, 3600]"
                    ...
                    <div class="pt-2 flex items-end">
                      ...
                      <Btn
                        ...
                        :primary="false"
                        :text="$t('initTemplate')"
                        v-if="refData.showInitializeTemplate"
                    ...
                    <div>
                      <div class="pt-2">
                        <InputField
                          :title="$t('dashboards.showOutline')"
                          v-model="refData.showOutLine"
                          :isRequired="false"
                          :isDisabled="false"
                ...
                <div class="basis-3/4 pb-3 h-full">
                  <div class="h-full">
                    <warp-view-editor
                      ...
                      width-px="600"
                      theme="dark"
                      id="wsContinuumEditor"
                      :warpscript="refData.script"
                      show-dataviz="false"
                      show-result="false"
                      show-execute="false"
                      config='{"quickSuggestionsDelay":3000, "suggestOnTriggerCharacters": false}'
                    >
                    </warp-view-editor>
                  </div>
                </div>
...
async function init() {
  ...
  refTagCollection.value = await crudController.index(1, 10, refSearch.value, {
    typeFilter: '1',
    namespace: refNamespace.value,
  })
  console.log(refTagCollection.value.data)
}
...
onUpdated(() => {
  if (props.modelValue == true) {
    setTimeout(() => {
      document
        .getElementById('wsContinuumEditor')!
