...
async function init() {
  ...
  refTag.value.type=2
  breadCrumb.value = [{ name: 'Projects', href: '/projects' }, { name: store.currentProject.name, href: routePrefix }, { name: t('navigation.texts'), href: routePrefix + '/texts' }, { name: t('tags.newText'), href: routePrefix + '/texts/create' }]
}
async function create() {
  refTag.value.name=Utils.camelCase(refTag.value.name)
