<template>
  <div id="page" class="h-full">
    <BaseLayoutVue
      ...
      :show-tool-bar="true"
      :bgColor="
        refEditorSwitch == true && refDashboard.type == 'Continuum' ? refDashboard.colorBg : 'white'
      "
      :enableImgBg="
        refEditorSwitch == true && refDashboard.type == 'Continuum'
          ? refDashboard.enableImgBg
          : undefined
      "
      :imgBgUrl="
        refEditorSwitch == true && refDashboard.type == 'Continuum' ? refImgBgUrl : undefined
      "
      class="h-full"
    >
      ...
      <template v-slot:menuLeft>
        <InputSwitch
          class="ml-3"
          :text1="
            refDashboard.type == 'Discovery'
              ? $t('tags.warpScriptEditor')
              : $t('dashboards.continuumDesigner')
          "
          :text2="''"
        ...
        <InputSwitch
          ...
          class="ml-3"
          :text1="$t('dashboards.float')"
          :text2="''"
          v-model="refFloatSwitch"
        >
        </InputSwitch>
        <a
      ...
      <template v-slot:menuRight class="p-3">
        ...
        ></Btn>
        <Btn
          v-if="refEdit == true && refEditorSwitch"
          :text="$t('new')"
          :primary="false"
          class="m-3"
          @click="addWidget"
      ...
      <template v-slot:default>
        ...
        <div
          class="h-fit flex"
          :style="
            refEditorSwitch && refDashboard.type == 'Discovery'
              ? 'height: ' + refCodeHeight + 'px;'
              : ''
          "
        >
          <form
            class="divide-gray-200 flex-grow h-fit"
            action="#"
            method="POST"
            @submit.prevent="saveDiscovery"
          >
            <div
              v-if="refEditorSwitch && refDashboard.type == 'Continuum'"
              class="hexa-dashboard pt-6 h-fit"
            >
              <DashboardGrid
